                ...
                {isOpen && (
                    <motion.div
                        ...
                        animate={{ 
                            ...
                            opacity: [0, 1],
                            transition:{
                                height: {type: "spring", stiffness: 500, damping: 18, overshootClamping: false },
                                opacity: { duration: 0.3, delay: 0.3 } 
                            }
                        }}
                        exit={{opacity: [1, 0], height: 0, transition: {opacity: { duration: 0.2 }, height: { duration: 0.2, delay: 0.2 }}}}
                    >
                        {children}
                    </motion.div>
                )}
